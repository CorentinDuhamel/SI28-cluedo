...
jQuery.iFisheye = {
    ...
    positionContainer: function (el, toAdd) {
        ...
        if (el.fisheyeCfg.halign == 'center') el.fisheyeCfg.container.get(0).style.left = (el.offsetWidth - el.fisheyeCfg.itemWidth * el.fisheyeCfg.items.length) / 2 - toAdd / 2 + 'px';
